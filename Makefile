...
# translation
SOURCES = topologyvalidator.py ui_topologyvalidator.py __init__.py topologyvalidatordialog.py
#TRANSLATIONS = i18n/topologyvalidator_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = topologyvalidator

PY_FILES = topologyvalidator.py topologyvalidatordialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_topologyvalidator.py
